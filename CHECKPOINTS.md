...
- 2353150 Võ Duy Thông: Giới thiệu các predicates, tập hợp, viết first-order formulas cho hard regulations (capacity, no double-booking, availability) và softer wishes (location preference, fatigue limits, fairness) (Req 1.1)
